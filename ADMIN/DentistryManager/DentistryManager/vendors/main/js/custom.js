...
function init_parsley() {
    ...
    //    validateFront();
    //});
    $('#antoform .btn').on('click', function () {
        $('#antoform').parsley().validate();
        validateFront();
    });
    var validateFront = function () {
        if (true === $('#antoform').parsley().isValid()) {
...
function init_calendar() {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        select: function (start, end, allDay) {
            $('#fc_create').click();
            //started = start._d.toLocaleString();
            //ended = end._d.toLocaleString();
            started = dateFormat(start._d, "mm/dd/yyyy");
            ended = dateFormat(end._d, "mm/dd/yyyy");

            $("#startdate").val(started);
            $("#enddate").val(ended);
        },
        ...
        eventSources: [
        {
            url: '/Base/GetAllEvents', // use the `url` property
            method: 'GET',
